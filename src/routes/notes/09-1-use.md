...
This exercise tries to measure our normative expectations for ethical AI use

1. Create scenarios of good/bad/borderline AI uses cases (as a group)
2. Vote on class scenarios (as an individual)

We'll use the following URL: https://aivote.streamlit.app

---

## Step 1: Scenario Submission

![](/slides/images/scenario-submission.png)

In groups of 3-5, collaboratively generate 2-3 distinct AI use cases per category, considering 'good/bad/borderline' from the perspective of *ethics*, *safety*, and *risk*
...
Paste your list items, in no particular order, into the 'Scenario Submission' tab
...
1. Switch to voting tab
2. Change your name to an individual name/psuedonym
3. Vote on all of the class scenarios
...
GPT-4 Third-Party Estimates: [5,184](https://hai.stanford.edu/ai-index/2025-ai-index-report/research-and-development)-[14,994](https://towardsdatascience.com/the-carbon-footprint-of-gpt-4-d6c676eb21ae/) CO2eq (varies based on estimates of grid carbon intensity)
...
## Training as manufacturing

Andy Masley ([2026](https://blog.andymasley.com/p/training-ai-models-doesnt-emit-that)) argues training emissions should be compared to **manufacturing** a consumer product, not to one person's annual footprint.

- One-time cost, amortized across hundreds of millions of users
- Training GPT-4 ≈ 3-4 days of iPhone manufacturing

![bg right:45% 95%](/slides/images/09/masley-iphone-vs-gpt4.png)

---

# A Mental Frame (In Megatons of CO2e)
*It's hard to wrap our heads around large numbers that serve millions*

Training GPT-4:                            0.015
Denver, community-wide annual:             7.2
[U.S. book publishing](https://www.publishersweekly.com/pw/print/20080310/15955-toward-a-greener-future.html):                      12
iPhone 16 manufacturing:                   12
Bitcoin mining, annual:                    80
[Livestock Emissions, annual](https://www.fao.org/statistics/highlights-archive/highlights-detail/greenhouse-gas-emissions-from-agrifood-systems.-global--regional-and-country-trends--2001-2023/en):                                          4300
[Livestock Supply Chain, annual](https://www.fao.org/family-farming/detail/en/c/1634679/): 7100

----

## Per-user math

Dividing GPT-4's ~15,000 tonnes by ~100-200M weekly users that model had:

> **75-150 grams CO2 per user** — about the footprint of manufacturing a single CD.

![bg right:40% 90%](/slides/images/09/masley-per-user-comparison.png)

<span class="footnote">Masley 2026; GPT-5 probably notably higher, but also sees 900M weekly users</span>
...
> OpenAI, Microsoft, Amazon, Alphabet, Meta, Anthropic, xAI/SpaceX, Alibaba, Deepseek, etc...

Problem #2: Companies are tooling for an large resource-use future
...
- cost per use (environmental and real) is falling; but use continues growing
- There are *massively* inflated bad-faith points out there
- Lots of redundancy in the industry - different companies are *each* training their own models
- A prompt for a trained model is low impact
- Better hardware is more efficient - improving our chips reduces wasted energy
- CO2 burden of power is critical - we can produce energy with very low environmental cost (solar, wind), and with very high cost (natural gas, coal); this makes estimates tricky for an industry is fundamentally an electricity-use burden
